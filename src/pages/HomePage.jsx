  ...
  return (
    <div className='min-h-screen min-w-screen relative'>
        <div className='absolute  min-w-screen top-3 max-sm:top-10 flex justify-center items-center  '>
            <div className='px-10 py-5 border-3 border-[#e095d7] bg-white z-10 rounded-xl shadow-2xl text-center max-sm:px-3 max-sm:py-2'>
        ...
        <div className='absolute min-w-screen bottom-2 flex justify-center items-center '>
            <button className='px-3 py-2 cursor-pointer text-sm font-semibold border-3 border-[#e095d7] bg-white z-10 rounded-xl shadow-xl' onClick={handleLogout}>Logout</button>
        </div>
